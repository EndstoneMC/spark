...
struct ResolvedFrame {
    ...
    // Validated function root for an unresolved main-module frame; recorded separately
    // from the sampled PC so offline evaluation can measure range coverage.
...
// Resolve frame keys via the platform symbol backend. Unresolved main-module frames
// may carry an evidence-tagged runtime guess; normal symbols are never annotated as guesses.
